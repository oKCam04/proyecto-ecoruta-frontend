        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="grid md:grid-cols-2 gap-8 py-14 md:py-20 items-center">
              ...
              <div className="relative">
                <div className="aspect-[4/3] w-full rounded-2xl bg-gradient-to-br from-emerald-600 to-emerald-400 shadow-2xl" />
                <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-lg p-4 border border-emerald-100">
